...
module.exports = {
   ...
   onStart: async function ({ message, role, rags, commandName, event, threadsData, getLang }) {
      if (!args[0])
   ...
   onChat: async function ({ event, message, usersData, getLang }) {
      ...
      const xyrene = {
         ...
         attachment: await global.utils.getStreamFromURL("https://i.imgur.com/DNgbXGd.jpeg")
            };
